...
public class XPreferences implements Property {
	...
	public boolean hasChildNode(String nodeName)
	{
		...
		for (XMLPreferences_XElement child: children)
		{
			...
			if (!nodeName.equals(nName)) continue;
	...
	/**
	 * Return a child XPreferences object with the key name NODENAME 
	 * the node will be created if it doesn't exist
	 * @param nodeName
	 * @return
	 */
	...
	/**
	 * Return the value stored for prefence named KEY
	 * If none is set or if an error occurs return the default value DEFAULTVALUE
	 * @param key
	 * @param defaultValue
	 * @return
	 */
	public String get(String key, String defaultValue)
	{
		...
		if (xelem == null) return defaultValue;
	...
	{
		if(!this.getChildNodeNames().contains(oldName)) return false;
...
//		xelem.setAtt(XPREFERENCES_NODENAMEKEY, value.toString());
	...
	public Property[] getSubProperties()
	{
		...
		{
			if (attName.equals(XPREFERENCES_NODENAMEKEY)) continue;
