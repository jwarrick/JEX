...
public class IconRepository {
	...
	public IconRepository(){
		...
		// initialize
		eyeImage     = getIconWithName(IconRepository.ENTRY_EYE, 22, 18);
		noeyeImage   = getIconWithName(IconRepository.ENTRY_NOEYE, 22, 18);
		validImage   = getIconWithName(IconRepository.ENTRY_VALID, 20, 20);
		invalidImage = getIconWithName(IconRepository.ENTRY_INVALID, 20, 20);
	}
	...
	public ImageIcon getJEXDataIcon(TypeName tn, int width, int height){
		...
		if (type.equals(JEXData.IMAGE) && tn.getDimension() == 2) result = iconPath + "XImageStack.png";
		else if (type.equals(JEXData.IMAGE)) result = iconPath + "XImage.png";
		else if (type.equals(JEXData.FILE)) result = iconPath + "XFile.png";
		else if (type.equals(JEXData.MOVIE)) result = iconPath + "XMovie.png";
		else if (type.equals(JEXData.VALUE)) result = iconPath + "XValue.png";
		else if (type.equals(JEXData.LABEL)) result = iconPath + "XLabel.png";
		else if (type.equals(JEXData.ROI)) result = iconPath + "XRoi.png";
		else if (type.equals(JEXData.TRACK)) result = iconPath + "XTrack.png";
		else if (type.equals(JEXData.FUNCTION_OLD)) result = iconPath + "XFunction.png";
		else result = iconPath + "XDefault.png";
