...
public class ImportThread implements Callable<Object> {
	...
	String objectName, objectType, objectInfo;
	TreeMap<JEXEntry,Vector<Pair<DimensionMap,String>>> dataArray;
	TreeMap<JEXEntry,JEXData> toAdd = new TreeMap<JEXEntry,JEXData>();
	
	public ImportThread(String objectName, String objectType, String objectInfo, TreeMap<JEXEntry,Vector<Pair<DimensionMap,String>>> dataArray)
	{
