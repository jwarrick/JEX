...
public class Slot extends WeakReference<Object>
{
	...
	public Slot( Object slotProvider, String slotMethod, Class<?>... slotArgTypes )
	{
		...
		try {
			...
			JEXStatics.logManager.log("Couldn't find method \"" + slotMethod + "\" in " + slotProvider.getClass().getSimpleName() + " to create the desired Slot object", 0, this);
			e.printStackTrace();
		}
	}
	...
	public Slot( Class<?> slotProvider, String slotMethod, Class<?>... slotArgTypes )
	{
		...
		try {
			...
			JEXStatics.logManager.log("Couldn't find method to create the desired Slot object", 0, this);
			e.printStackTrace();
		}
	}
	...
	public void invoke(Object... args)
	{
		try {
			...
			JEXStatics.logManager.log("Couldn't find desired method in " + this.get().getClass().getSimpleName(), 0, this);
		}
	}
	...
	public boolean equals( Object anObject )
	{
		...
		// If they are the same, they probably the same Method object so test that first
