...
public class DataBrowser implements Scrollable {
	...
	{
		// Only add dimensions that aren't already included in the image DimTable
	...
	{		
		...
		{
			this.imageBars = new DimTableAdjuster(dimTable); // null handled in constructor
		...
		{
			this.imageBars.setDimTable(dimTable); // set method handles null argument
		}
	}
...
//	}
	...
	public void entryChanged(){
		...
		// JEXStatics.logManager.log("Send signal of entry changed", 1, this);
	...
	public void imageDimChanged(){
		// Emit signal of experiment tree change
		// JEXStatics.logManager.log("Send signal of dimension changed", 1, this);
	...
	public int getScrollableUnitIncrement(Rectangle bounds, int direction, int units) {
		...
		{
			if(units < 0) return (int) (bounds.height*0.1);
		}
		return 0;
	}
