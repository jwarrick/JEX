...
//		b.setText(name);
	...
	{
		JEXStatics.logManager.log("Set View Mode", 0, this);
	...
	{
		JEXStatics.logManager.log("Set Move Mode", 0, this);
	...
	{
		JEXStatics.logManager.log("Set Create Mode", 0, this);
