...
public class RectDelegate extends RoiDelegate {
	...
	{
		if(transformedList.size() == 2) g2.draw(transformedList.getBounds());
	...
	public void leftClicked(Point p)
	{
		...
		if(this.editablePoints.size() == 2) this.roiFinished();
		else this.roiUpdated();
	}
	@Override
	public void rightClicked(Point p){ JEXStatics.logManager.log("rightClicked", 0, this);}
	@Override
	...
	@Override
	public void handleLeftClicked(Point p){ JEXStatics.logManager.log("handleLeftClicked", 0, this);}
	@Override
	public void handleRightClicked(Point p){ JEXStatics.logManager.log("handleRightClicked", 0, this);}
