...
public class ChangeSet<E extends Copiable<E>> {
	...
	public boolean containsName(String name)
	{
		...
		{
			temp = this.map.get(e);
			if(temp.containsKey(name)) return true;
		}
		return false;
	}
...
//		else
//		{
//			//JEXStatics.logManager.log("Can't add old object! An old object already exists for this entry and newName", 0, this);
//			return false;
//		}
...
//	}
	...
	public boolean updateObjectWithChangedName(JEXEntry e, E object, String oldName, String newName)
	{
		...
		if(temp == null)
		{
			JEXStatics.logManager.log("Can't change name! No change map found for this entry", 0, this);
			return false;
		}
		ChangeMap<E> changeMap = temp.get(oldName);
		if(changeMap == null)
		{
			JEXStatics.logManager.log("Can't change name! No change map found for this entry and oldName", 0, this);
			return false;
		}
		else
		{
	...
	{
		if(e == null || newName == null) return null;
		HashMap<String,ChangeMap<E>> temp = this.map.get(e);
