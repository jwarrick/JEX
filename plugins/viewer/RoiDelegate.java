...
public class RoiDelegate {
	...
	/**
	 * accepts null argument to create an empty roi. an empty PointList and null
	 * both result in the same RoiDelegate
	 * @param pl
	 */
	public RoiDelegate(PointList roi, List<PointList> smashedRois)
	{
		if(roi == null) editablePoints = new PointList();
		else editablePoints = roi;
		if(smashedRois == null) smashedRois = new Vector<PointList>();
		else this.smashedPoints = smashedRois;
		//if(this.points.size() == 0) this.paint(); // results in update and create mode
	...
	{
		if(ofTotal < 2) return new Color(0,0,255);
	...
	//public Point getReferenceOfPointAt(Point p){ return this.points.getReferenceOfPointAt(p);}
	public void roiUpdated() { SSCenter.defaultCenter().emit(this, SIG_RoiUpdated_Null, (Object[])null);}
	public void roiFinished() { SSCenter.defaultCenter().emit(this, SIG_RoiFinished_Null, (Object[])null);}
	public Color[] getHandleBorderAndFillColor(int index) { return defaultHandle;}
	public int size() { return editablePoints.size();}
	public Rectangle getBounds()
	{
		Rectangle ret = this.editablePoints.getBounds();
		return ret;
	}
	public List<Point> getLines(){ return this.lines;}
	
	// Reimplement these in all subclasses;
	public boolean isLineType(){ return false;}
	public void paintLinesForPointList(Graphics2D g2, PointList transformedPoints, int mode, Point cursorLocation){}
	
	public boolean pointIsInRoi(Point p){ return false;}

	public void leftClicked(Point p){};
	public void rightClicked(Point p){}
	public void dragging(Rectangle r){}
	public void dragFinished(Rectangle r){}
	public void finishRoi(){ SSCenter.defaultCenter().emit(this, SIG_RoiFinished_Null, (Object[])null);}
	
	public void handleLeftClicked(Point p){}
	public void handleRightClicked(Point p){}
	
	// This should be called to keep the lineList updated for future calls to paint()
