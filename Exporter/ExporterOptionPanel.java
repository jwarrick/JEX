...
public class ExporterOptionPanel extends DialogGlassCenterPanel implements ActionListener{
	...
	@Override
	public void yes(){
		JEXStatics.logManager.log("Exporting data ", 1, this);
		...
		if (exportmode.equals("1D")) exportModeInt = Exporter.EXPORTLIST;
	...
	@Override
	public void cancel(){
		JEXStatics.logManager.log("Data export cancelled", 1, this);
	}
