...
public class DialogGlassMessagePanel extends DialogGlassCenterPanel implements ActionListener{
	private static final long serialVersionUID = 1L;
	private JLabel  message   = new JLabel();
	private Method method;
	private Object listener;

	public DialogGlassMessagePanel(String message){
	...
	@Override
	public void yes(){
		JEXStatics.logManager.log("Message passed - ok answered", 1, this);
		try {
	...
	@Override
	public void cancel(){
		JEXStatics.logManager.log("Message passed - no answered", 1, this);
	}
