...
public class JRoundedPanel extends JPanel{
	...
	public void refresh(){
		...
		if (!right) this.add(Box.createRigidArea(new Dimension(spacing,spacing)),BorderLayout.LINE_END);
		if (!left) this.add(Box.createRigidArea(new Dimension(spacing,spacing)),BorderLayout.LINE_START);
		if (!top) this.add(Box.createRigidArea(new Dimension(spacing,spacing)),BorderLayout.PAGE_START);
		if (!bottom) this.add(Box.createRigidArea(new Dimension(spacing,spacing)),BorderLayout.PAGE_END);
