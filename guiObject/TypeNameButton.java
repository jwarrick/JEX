...
// ----------------------------------------------------
	...
	public void openInfoPanel(){
		JEXStatics.logManager.log("Opening info panel on the object "+objectTN.toString(), 1, this);
		//TODO
	}
	...
	public void openInDefaultProgram(){
		JEXStatics.logManager.log("Opening object "+objectTN.toString()+ " in default program", 1, this);
		if (objectTN == null) return;
...
//		}
	...
	public void loadInFunctionPanel(){
		JEXStatics.logManager.log("Load object "+objectTN.toString()+ " in function panel", 1, this);
		//TODO
	}
	...
	public void exportArray(){
		JEXStatics.logManager.log("Export object "+objectTN.toString()+ " array", 1, this);
		//TODO
	}
	...
	public void removeObjects(){
		int n = JOptionPane.showConfirmDialog(JEXStatics.main,"Delete selected object in each selected well?",
	...
	public boolean isObjectAFunction(){
		if (this.objectTN.getType().equals("Function")) return true;
		return false;
	}
...
//		iconImage = new ImagePlus("icon", imp);
	...
	class ButtonObjectListener extends MouseAdapter {
		...
		public void mousePressed(MouseEvent e) {
			JEXStatics.logManager.log("Mouse pressed", 2, this);
		}
		@Override
		public void mouseReleased(MouseEvent e) {
			JEXStatics.logManager.log("Mouse released", 2, this);
			if (e.getSource() instanceof JMenuItem) doit(e);
		}
