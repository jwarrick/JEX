...
public class FormGlassPane extends DialogGlassCenterPanel implements ActionListener{
	...
	private void initialize(){
		...
		for (int i=0; i<size; i++) rspecs[i] = new RowSpec(RowSpec.CENTER, Sizes.dluX(14), FormSpec.NO_GROW);
	...
	@Override
	public void yes(){
		JEXStatics.logManager.log("Form pane validated", 1, this);
	...
	@Override
	public void cancel(){
		JEXStatics.logManager.log("Form pane cancelled", 1, this);
	}
