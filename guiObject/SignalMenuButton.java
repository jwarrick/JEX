...
public class SignalMenuButton extends JPanel implements MouseListener {
	...
	private void refresh(){
		label = new JLabel();
		label.setText(text);
		if(userFont != null) label.setFont(userFont);
		label.setIcon(icon);
...
//		this.setPreferredSize(d);
	...
	/**
	 * Set the icon displayed in the button from image at path PATH 
	 * and dimension D
	 * @param path
	 * @param d
	 */
	...
	/**
	 * Set the icon displayed when the mouse is over the button from image at path PATH 
	 * and dimension D
	 * @param path
	 * @param d
	 */
	...
	/**
	 * Set the icon displayed when the mouse button pressed from image at path PATH 
	 * and dimension D
	 * @param path
	 * @param d
	 */
	...
	/**
	 * Set the icon displayed when the enabled flag is set to false from image at path PATH 
	 * and dimension D
	 * @param path
	 * @param d
	 */
...
//		this.repaint();
	...
	public void mouseEntered(MouseEvent e) {
		...
		if (mouseOverIcon != null) label.setIcon(mouseOverIcon);
		label.repaint();
	}
	...
	public void mousePressed(MouseEvent e) {
		...
		if (mousePressedIcon != null) label.setIcon(mousePressedIcon);
