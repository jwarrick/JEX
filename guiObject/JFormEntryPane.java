...
public class JFormEntryPane extends JPanel {
	private static final long serialVersionUID = 1L;
		...
		private void initialize(){
			...
			if (entry.note !=  null) resultField.setToolTipText(entry.note);
		...
		public String getValue(){
			String result;
			if (entry.type.equals(FormLine.DROPDOWN) && entry.options != null){  
				result = ((JComboBox)resultField).getSelectedItem().toString();}
			else if (entry.type.equals(FormLine.CHECKBOX) && entry.options != null){  
