...
public class StringUtility implements Comparator<String>{
	...
	public static String[] removeFromArray(String[] array, String s){
		if (!StringUtility.isMember(s, array)) return array;
	...
	public static String endingString(String s, String prefix){
		if (!begginWith(s,prefix)) return null;
	...
	*/
	...
	public static void saveText(String text, String path){
		...
		catch (IOException e) { System.out.println("ERROR saving text file"); }
	}
...
//		return 0;
	 ...
	 * @return width of string in pixel
	 */
	public static int getStringWidthv2(String str, Font font){
		Graphics g = jex.statics.JEXStatics.main.getGraphics();
