...
public class EntryInArrayPreviewController 
{
	...
	public EntryInArrayPreview arrayPreview;
	public Tray                tray;
	...
	public EntryInArrayPreviewController()
	{
...
//		rebuildModel();
	...
	public void rebuildModel()
	{
		...
		{
			if (arrayPreview==null) arrayPreview = new EntryInArrayPreview();
			showLegend();
	...
	private JEXLabel getCurrentLabelInEntry(JEXEntry e)
	{
		...
		if (!selectedObj.getType().equals(JEXData.LABEL)) return null;
	...
	class EntryInArrayPreview implements PaintComponentDelegate, MouseListener, MouseMotionListener
	{
		...
		{
			if((rows == 0 && cols == 0) || index.x < -1 || index.y < -1 || index.x > cols || index.y > rows) return;
