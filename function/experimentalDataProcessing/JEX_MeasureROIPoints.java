 ...
 *
 */
public class JEX_MeasureROIPoints extends ExperimentalDataCrunch{
	
	public JEX_MeasureROIPoints(){}
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		ROIPlus templateRoi = getRoi(roiOrigin, roiType, roiWidth, roiHeight);
		...
		try
		{
			...
			JEXStatics.logManager.log("Performing " + total + " total measurements on " + imageTable.mapCount() + " total images.", 0, this);
			for(DimensionMap imMap : imageTable.getIterator())
			{
...
//								this.writeBlankData(writer, map);
	...
	private void writeData(JEXTableWriter2 writer, DimensionMap map, ImageStatistics stats, IdPoint p, DecimalFormat formatD)
	{
		// Write the data to the ongoing file
