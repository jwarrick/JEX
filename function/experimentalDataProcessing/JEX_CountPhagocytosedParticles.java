...
public class JEX_CountPhagocytosedParticles extends ExperimentalDataCrunch{
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		if (sporeRoiData == null || !sporeRoiData.getTypeName().getType().equals(JEXData.ROI)) return false;

		// Collect the inputs
		JEXData cellRoiData = inputs.get("Cell ROI");
		if (cellRoiData == null || !cellRoiData.getTypeName().getType().equals(JEXData.ROI)) return false;

		// Collect the inputs
		JEXData cellWithoutRoiData = inputs.get("Cell without spores ROI");
		if (cellWithoutRoiData == null || !cellWithoutRoiData.getTypeName().getType().equals(JEXData.ROI)) return false;
		...
		for (DimensionMap dim: sporeRois.keySet())
		{
			...
			if (sporeRoi == null || cellRoi == null || cellNOTRoi == null) continue;
