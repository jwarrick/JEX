 ...
 *
 */
public class JEX_Calculator_BasicArithmetic extends ExperimentalDataCrunch{
	...
	public ParameterSet requiredParameters() {
		...
		Parameter p0 = new Parameter("Operation","Select the arithmetic operation to apply.",FormLine.DROPDOWN,new String[] {"Add","Subtract","Divide","Multiply"},0);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		// Check the inputs
		if (value1Data == null || !value1Data.getTypeName().getType().equals(JEXData.VALUE)) return false;
		if (value2Data == null || !value2Data.getTypeName().getType().equals(JEXData.VALUE)) return false;
