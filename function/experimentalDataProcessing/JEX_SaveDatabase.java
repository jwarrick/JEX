 ...
 *
 */
public class JEX_SaveDatabase extends ExperimentalDataCrunch{
	
	public JEX_SaveDatabase(){}
	...
	public String getName() {
		String result = "Save the Current Database";
		return result;
	}
	...
	public String getInfo() {
		String result = "Function that saves the current database.";
		return result;
	}
	...
	public TypeName[] getOutputs(){
		...
		defaultOutputNames[0] = new TypeName(VALUE,"Save Time-stamp");
	...
	public ParameterSet requiredParameters() {
		Parameter p0 = new Parameter("Dummy Parameter","Parameter to indicate that function was successfully selected.",FormLine.DROPDOWN,new  String[]{"true"}, 0);
...
//		parameterArray.addParameter(p6);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		JEXStatics.logManager.log("Function Save Time-stamp: " + getDateTime(), 0, this);
		JEXData output1 = ValueWriter.makeValueObject(outputNames[0].getName(), getDateTime());
