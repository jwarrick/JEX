 ...
 *
 */
public class JEX_FindMaximaSegmentation extends ExperimentalDataCrunch{
...
//		Parameter p0 = new Parameter("Dummy Parameter","Lets user know that the function has been selected.",FormLine.DROPDOWN,new String[] {"true"},0);
		...
		Parameter p4 = new Parameter("Is EMD?","Is the image being analyzed already a Euclidean Distance Measurement?",FormLine.DROPDOWN, new String[] {"True", "False"}, 1);
...
//		parameterArray.addParameter(p0);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		boolean isEDM = Boolean.parseBoolean(parameters.getValueOfParameter("Is EMD?"));
