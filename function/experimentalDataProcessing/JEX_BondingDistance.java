 ...
 *
 */
public class JEX_BondingDistance extends ExperimentalDataCrunch{
...
class BondStrengthAnalysisFunction implements ActionListener, ImageDisplayController {
	...
	BondStrengthAnalysisFunction(JEXEntry entry, JEXData data, TypeName[] outputNames, ParameterSet parameters){
		...
		// Param panel
		p1 = new JParameterEntryPanel(parameters.getParameter("Micron per pixel"));
	...
	private void makeValueTable(){
		...
		if (currentPointList == null) currentPointList = new PointList();
		if (linePoint1 == null || linePoint2 == null) return;
	...
	private void drawGuideLines(){
		if (linePoint2 == null || linePoint1 == null) return;
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == restartButton){
			JEXStatics.logManager.log("Restart",1,this);
