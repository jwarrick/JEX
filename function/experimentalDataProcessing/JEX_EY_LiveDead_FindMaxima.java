 ...
 *
 */
public class JEX_EY_LiveDead_FindMaxima extends ExperimentalDataCrunch{
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs){
		...
		// Extract just the images from the imsets, and store as array lists of JEXImage type
...
//		liveMaxima = maximumFinder1.findMaxima(bimPlus1, toleranceLive, threshold1, outputType1, excludeOnEdges, isEDM);
//		deadMaxima = maximumFinder2.findMaxima(bimPlus2, toleranceDead, threshold2, outputType2, excludeOnEdges, isEDM);
...
//		String newFileName1  = FunctionUtility.getNextName(localDir, currentName1, "L");
...
//		String newFileName2  = FunctionUtility.getNextName(localDir, currentName2, "D");
...
//		imFS.saveAsTiff(finalPath3);
		...
		JEXStatics.logManager.log("Saving the live, dead and merged image", 1, this);
