 ...
 *
 */
public class JEX_FindMaxandCount extends ExperimentalDataCrunch {
	...
	public ParameterSet requiredParameters() {
		...
		Parameter p4 = new Parameter("Mode","Which type of calculation to perform?",FormLine.DROPDOWN,new String[] {"Threshold","Fixed number"},1);
		...
		Parameter p7 = new Parameter("Loop order","Reverse looping order?",FormLine.DROPDOWN,new String[] {"Normal","Reverse"},1);
