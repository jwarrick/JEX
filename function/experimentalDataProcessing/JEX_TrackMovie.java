 ...
 *
 */
public class JEX_TrackMovie extends ExperimentalDataCrunch {
	...
	public String getName() {
		String result = "Make track movie";
		return result;
	}
...
//	}
	...
	public ParameterSet requiredParameters() {
		...
		Parameter p4 = new Parameter("Track Color","Choose the color to represent tracks",FormLine.DROPDOWN,new String[] {"Yellow","Red","Green","Blue","Black"},0);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs){
		...
		if (!data1.getTypeName().getType().equals(JEXData.TRACK)) return false;
...
//		String vhPath      = JEXWriter.getDatabaseFolder() + File.separator + JEXWriter.getUniqueTempPath("avi");
//		makeMovieAndSaveToPath(trajectories,imPaths,vhPath);
//		
//		// Collect the outputs
//		JEXStatics.logManager.log("Collecting outputs", 1, this);
//		JEXData movie      = MovieWriter.makeMovieObject(outputNames[0], vhPath, "Mov");
//		realOutputs.add(movie);
	...
	public void makeMovieAndSaveToPath(List<Trajectory> trajectories, String[] imList, String path){
		...
		int binning       = 1;
		try{ binning = Integer.parseInt(parameters.getValueOfParameter("Image Scale"));} 
