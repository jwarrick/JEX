 ...
 *
 */
public class JEX_MakeFACSMeanPlots extends ExperimentalDataCrunch{
...
//		parameterArray.addParameter(p14);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		JEXData output2 = FileWriter.makeFileObject(outputNames[1].getName(), outpathData, "AvgExpression");
