 ...
 *
 */
public class JEX_NuclearStainCellCounter extends ExperimentalDataCrunch{
	...
	public ParameterSet requiredParameters() {
		...
		Parameter p2 = new Parameter("Erode-Dilate","Erode dilate to remove small clusters",FormLine.DROPDOWN,new String[] {"true","false"},0);
		...
		//Parameter p10 = new Parameter("Outliers","Remove outliers as percentile of found clusters","0.05");
...
class NuclearCellCounter implements GraphicalCrunchingEnabling, ImagePanelInteractor{
	...
	private void preProcess(){
		...
		JEXStatics.logManager.log("Image processor reached",1,this);
...
//		double maxSize = Double.POSITIVE_INFINITY;
		...
		JEXStatics.logManager.log("Image particle analyzer performed returned "+done,1,this);
