 ...
 *
 */
public class JEX_CountPointsInROI extends ExperimentalDataCrunch{
	
	public JEX_CountPointsInROI(){}
	...
	public String getName() {
		String result = "Count Points in ROI";
		return result;
	}
	...
	public String getInfo() {
		String result = "Function that allows you to count the number of points within a regional ROI.";
		return result;
	}
	...
	public TypeName[] getOutputs(){
		...
		defaultOutputNames[0] = new TypeName(ROI,"Contained ROI Points");
		defaultOutputNames[1] = new TypeName(VALUE,"Point Count");
		defaultOutputNames[2] = new TypeName(VALUE,"Total Point Count");
...
//		parameterArray.addParameter(p6);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		if (pointData == null || !pointData.getTypeName().getType().equals(JEXData.ROI)) return false;

		// Collect the inputs
		JEXData regionData = inputs.get("Region ROI");
		if (regionData == null || !regionData.getTypeName().getType().equals(JEXData.ROI)) return false;
		...
		Shape regionShape;
		TreeMap<DimensionMap,ROIPlus> outputROI = new TreeMap<DimensionMap,ROIPlus>();
		...
		JEXData output2 = ValueWriter.makeValueTable(outputNames[1].getName(), outputCounts);
		JEXData output3 = ValueWriter.makeValueObject(outputNames[2].getName(), ""+count);
