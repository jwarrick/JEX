 ...
 *
 */
public class JEX_BackGroundSubtract extends ExperimentalDataCrunch{
	...
	public TypeName[] getOutputs() {
		...
		defaultOutputNames[0] = new TypeName(IMAGE,"Background subtracted");
	...
	public ParameterSet requiredParameters() {
		...
		Parameter p2 = new Parameter("Inverted","Generally false but true if imaging absorbance",FormLine.DROPDOWN,new String[] {"true","false"},1);
		Parameter p3 = new Parameter("Extract background","Make background image",FormLine.DROPDOWN,new String[] {"true","false"},1);
		Parameter p4 = new Parameter("Paraboloid","Use a sliding paraboloid",FormLine.DROPDOWN,new String[] {"true","false"},1);
		Parameter p5 = new Parameter("Presmoothing","Do a presmoothing",FormLine.DROPDOWN,new String[] {"true","false"},0);
		Parameter p6 = new Parameter("Output Bit Depth","Depth of the outputted image",FormLine.DROPDOWN,new String[] {"8","16","32"},1);
		Parameter p7 = new Parameter("Normalize","Normalize image on save",FormLine.DROPDOWN,new String[] {"true","false"},1);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs){
		...
		boolean inverse           = Boolean.parseBoolean(parameters.getValueOfParameter("Inverted"));
		boolean extractBackground = Boolean.parseBoolean(parameters.getValueOfParameter("Extract background"));
		boolean paraboloid        = Boolean.parseBoolean(parameters.getValueOfParameter("Paraboloid"));
		boolean presmooth         = Boolean.parseBoolean(parameters.getValueOfParameter("Presmoothing"));
		int outputDepth           = Integer.parseInt(parameters.getValueOfParameter("Output Bit Depth"));
		//boolean normalize         = Boolean.parseBoolean(parameters.getValueOfParameter("Normalize"));
...
//			if(localDir == null)
//				JEXStatics.logManager.log("Null local directory returned!!!!!", 0, this);
