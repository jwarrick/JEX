 ...
 *
 */
public class JEX_AverageMigrationDistance extends ExperimentalDataCrunch{
...
class MigrationDistanceAnalysisFunction implements ActionListener, ImageDisplayController {
	...
	private void initialize()
	{
		...
		// Param panel
		p1 = new JParameterEntryPanel(params.getParameter("Micron per pixel"));
	...
	{
		// Save the roi
		if (this.currentPList == null) return;
		ROIPlus polygon = new ROIPlus(this.currentPList,ROIPlus.ROI_POLYGON);
