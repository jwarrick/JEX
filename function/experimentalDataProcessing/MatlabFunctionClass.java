 ...
 *
 */
public class MatlabFunctionClass extends ExperimentalDataCrunch{
	private String path ;
	
	public MatlabFunctionClass(String path){
		this.path = path;
	}
	...
	public String getInfo() {
		String result = "Information about the template function";
		return result;
	}
	...
	public String getToolbox() {
		String toolbox = "Template toolbox";
		return toolbox;
	}
	...
	public TypeName[] getInputNames(){
		...
		inputNames[0] = new TypeName(IMAGE,"Input 1");
		inputNames[1] = new TypeName(IMAGE,"Input 2");
		return inputNames;
	}
	...
	public TypeName[] getOutputs(){
		...
		defaultOutputNames[0] = new TypeName(IMAGE,"Output 1");
	...
	public ParameterSet requiredParameters() {
		// Example parameters
		Parameter parameter1 = new Parameter("Label");
		Parameter parameter2 = new Parameter("Threshold","Image background threshold","10");
		
		// Make an array of the parameters and return it
		ParameterSet parameterArray = new ParameterSet();
		parameterArray.addParameter(parameter1);
		parameterArray.addParameter(parameter2);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs){
		...
		JEXStatics.logManager.log("Running matlab file "+path, 1, this);
