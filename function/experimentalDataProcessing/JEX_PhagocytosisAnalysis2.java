 ...
 *
 */
public class JEX_PhagocytosisAnalysis2 extends ExperimentalDataCrunch{
	...
	public ParameterSet requiredParameters() {
		...
		Parameter p4 = new Parameter("Watershed","Do a watershedding to split cells close together",FormLine.DROPDOWN,new String[] {"true","false"},0);
...
//		imageDisplay.setImage(new ImagePlus(cellPath));
	...
	public void doit(){
		...
		//auto = true;
		if (auto){
			JEXStatics.logManager.log("Processing Live Image",1,this);
			processCellImage();
			JEXStatics.logManager.log("Analyzing Live Image",1,this);
			analyzeCellImage();
			JEXStatics.logManager.log("Processing Dead Image",1,this);
			processParticleImage();
			JEXStatics.logManager.log("Analyzing Dead Image",1,this);
			analyzeParticleImage();
			JEXStatics.logManager.log("Analyzing Results",1,this);
			analyze();
		}
		else {
			wrap.start();
...
//			imageDisplay.setImage(new ImagePlus(cellMaskPath));
	...
	private void processCellImage()
	{
		...
		// Make Overlay Image
//		ColorProcessor color1 = (ColorProcessor) cellImp.convertToByte(true).convertToRGB();
...
//		JEXStatics.logManager.log("Saved image at path "+cellPathMerge, 1, this);
	...
	private void processParticleImage()
	{
		...
		// Find the thresholding level, using an automated algorithm if necessary
