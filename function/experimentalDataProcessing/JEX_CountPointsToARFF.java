 ...
 *
 */
public class JEX_CountPointsToARFF extends ExperimentalDataCrunch{
	
	public JEX_CountPointsToARFF(){}
	...
	public ParameterSet requiredParameters() {
		Parameter p0 = new Parameter("File Extension","Lets user know that the function has been selected.",FormLine.DROPDOWN,new String[] {"arff","csv"},0);
...
//		parameterArray.addParameter(p6);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		String path = JEXTableWriter2.writeTable("Point Counts", new Table<Double>(outputDimTable,outputCounts));
		JEXData output1 = FileWriter.makeFileObject(outputNames[0].getName(), path, "Count");
