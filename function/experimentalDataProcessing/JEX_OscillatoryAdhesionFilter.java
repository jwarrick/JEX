 ...
 *
 */
public class JEX_OscillatoryAdhesionFilter extends ExperimentalDataCrunch{
...
//		Parameter p0 = new Parameter("Get Background From Timpoint i","Choose the timepoint to get background information from.","0");//		Parameter p0 = new Parameter("Dummy Parameter","Parameter to indicate that you have selected this function",FormLine.DROPDOWN,new String[]{"true"},0);
...
//		parameterArray.addParameter(p6);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		// int bgTimePoint = Integer.parseInt(parameters.getValueOfParameter("Get Background From Timpoint i"));
		...
		count = stackMaps.size(); // Update counter here after cullImages and stack
	...
	{
		if(imagePaths.size() == 0 || stackMaps.size() == 0) return;
		ImagePlus im;
		ImageStatistics stats;
		List<Double> imMeans = new Vector<Double>(0);
		String path;
