 ...
 *
 */
public class JEX_ExportFiles extends ExperimentalDataCrunch{
	...
	public ParameterSet requiredParameters() {
		Parameter p1 = new Parameter("Folder Path","Location to which the files will be copied","/Users/warrick/Desktop/R Scripts/CellTracking/Temp");
		Parameter p2 = new Parameter("File Extension", "Extension to put on the file", FormLine.DROPDOWN, new String[]{"csv","arff","txt"},0);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs){
		...
		String folderPath = parameters.getValueOfParameter("Folder Path");
		String ext = parameters.getValueOfParameter("File Extension");
		...
		for (DimensionMap dim : filePaths.keySet()){
			...
			String newFilePath = folder.getAbsolutePath() + File.separator + FileUtility.getFileNameWithoutExtension(fileName) + "." + ext;
			
			FileUtility.copy(f, new File(newFilePath));
