 ...
 *
 */
public class JEX_RectCoordStitchND extends ExperimentalDataCrunch{
	
	public static final int LtoR = 0, TtoB = 1;
	
	public JEX_RectCoordStitchND(){}
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		// Remove the row and col Dim's from the DimTable and iterate through it and stitch.
		table.remove(rowDim);
		table.remove(colDim);
