 ...
 *
 */
public class JEX_MeasureROILineSegment extends ExperimentalDataCrunch{
	
	public JEX_MeasureROILineSegment(){}
	...
	public ParameterSet requiredParameters() {
		Parameter p0 = new Parameter("Angle Range","Choose the way in which the angle is measured by indicating the limits of the measurement.",FormLine.DROPDOWN,new String[] {"-pi/2 to pi/2", "-pi to pi"},0);
		Parameter p1 = new Parameter("First Measurement Only","Choose to return a table of values for multi-dimensional image object or just a single value representing the first measurement",FormLine.DROPDOWN, new String[]{"true","false"},0);
...
//		parameterArray.addParameter(p6);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		for(DimensionMap map : maps)
		{
			...
			{
				if(roi.type != ROIPlus.ROI_LINE) return false;
