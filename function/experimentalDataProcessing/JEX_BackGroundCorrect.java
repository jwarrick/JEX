 ...
 *
 */
public class JEX_BackGroundCorrect extends ExperimentalDataCrunch{
	...
	public String getName() {
		String result = "Background Correct";
		return result;
	}
	...
	public String getInfo() {
		String result = "Subtract background of image and correct for uneven illumination";
		return result;
	}
	...
	public TypeName[] getOutputs() {
		...
		defaultOutputNames[0] = new TypeName(IMAGE,"Background Corrected");
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs){
		...
		boolean extractBackground = true;
