 ...
 *
 */
public class JEX_CountPoints extends ExperimentalDataCrunch{
	
	public JEX_CountPoints(){}
	...
	public TypeName[] getOutputs(){
		...
		defaultOutputNames[0] = new TypeName(VALUE,"Point Count");
...
//		parameterArray.addParameter(p6);
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		JEXData output1;
		if(pointROI.keySet().size() == 1)
		{
			output1 = ValueWriter.makeValueObject(outputNames[0].getName(), ""+count);
		}
		else
		{
			output1 = ValueWriter.makeValueTable(outputNames[0].getName(), outputCounts);
		}
