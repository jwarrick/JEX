...
public class FigureFactory {
	 ...
	 * @return
	 */
	public static ChartPanel make_CART_LINE(String title,
			String xlabel,String xunit,List<Double> Xvalues,
			String ylabel,String yunit,List<Double> Yvalues){
	 ...
	 * @return
	 */
	public static ChartPanel make_XYSTEP_Chart(String title,
			String xlabel,String xunit,List<Double> Xvalues,
			String ylabel,String yunit,List<Double> Yvalues){
		...
		JFreeChart chart = ChartFactory.createXYStepChart(title, xlabel,ylabel, 
				data,PlotOrientation.VERTICAL,false,false,false);
		chart.setBackgroundPaint(Color.white);
	 ...
	 * @return
	 */
	public ChartPanel make_CART_HISTOGRAM(String title,
			String xlabel,String xunit,List<Double> Xvalues,
			String ylabel,String yunit,List<Double> Yvalues){
		...
		JFreeChart chart = ChartFactory.createXYBarChart(title, xLabel, false, yLabel, 
				data,PlotOrientation.VERTICAL,false,false,false);
		chart.setBackgroundPaint(Color.white);
		...
		if (maxX > 0) vaxis.setRange(0.0, maxX); // Set the range of displayed values
	 ...
	 * @return
	 */
	public static ChartPanel make_CART_SCATTER(String title,
			String xlabel,String xunit,List<Double> Xvalues,
			String ylabel,String yunit,List<Double> Yvalues){
		...
		JFreeChart chart = ChartFactory.createScatterPlot(title, xlabel, ylabel, 
				data,PlotOrientation.VERTICAL,false,false,false);
		chart.setBackgroundPaint(Color.white);
	 ...
	 * @return
	 */
	public static ChartPanel make_POLAR_SCATTER(String title,
			String xlabel,String xunit,List<Double> Xvalues,
			String ylabel,String yunit,List<Double> Yvalues){
	 ...
	 * @return
	 */
	public ChartPanel make_POLAR_LINE(String title,
			String xlabel,String xunit,List<Double> Xvalues,
			String ylabel,String yunit,List<Double> Yvalues,
			double maxy){
	 ...
	 * @return
	 */
	public static ChartPanel make_PLOAR_HISTOGRAM(String title,
			String xlabel,String xunit,List<Double> Xvalues,
			String ylabel,String yunit,List<Double> Yvalues){
