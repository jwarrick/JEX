...
public class AutoThresholder {
	...
	public static final int HUANG=0;
	public static final int INTERMODES=1;
	public static final int ISODATA=2;
	public static final int LI=3;
	public static final int MAXENTROPY=4;
	public static final int MEAN=5;
	public static final int MINERROR=6;
	public static final int MINIMUM=7;
	public static final int MOMENTS=8;
	public static final int OTSU=9;
	public static final int PERCENTILE=10;
	public static final int RENYIENTROPY=11;
	public static final int SHANBHAG=12;
	public static final int TRIANGLE=13;
	public static final int YEN=14;
	...
	{
		if (method<0) throw new IllegalArgumentException("Method not found");
		//int threshold = 0;
		switch (method) {
	...
	public int getThreshold(String method, int[] histogram) {
		...
		return getThreshold(index, histogram);
	}
	...
	int Intermodes(int [] data ) {
		...
		while (!bimodalTest(iHisto) ) {
			...
			if (iter>10000) {
				threshold = -1;
				JEXStatics.logManager.log("Intermodes Threshold not found after 10000 iterations.",2,this);
				return threshold;
			}
		}
	...
	int MinErrorI(int [] data ) {
		...
		while (threshold!=Tprev){
			...
			sqterm = (w1*w1)-w0*w2;
			if (sqterm < 0) {
				JEXStatics.logManager.log("MinError(I): not converging. Try Ignore black/white options",2,this);
				return threshold;
			}
			...
			if ( Double.isNaN(temp)) {
				JEXStatics.logManager.log ("MinError(I): NaN, not converging. Try Ignore black/white options",2,this);
				threshold = Tprev;
			}
			else
	...
	int Minimum(int [] data ) {
		...
		while (!bimodalTest(iHisto) ) {
			...
			if (iter>10000) {
				threshold = -1;
				JEXStatics.logManager.log("Minimum Threshold not found after 10000 iterations.",2,this);
				return threshold;
			}
		}
