...
// ASK ERWIN WHETHER THE DEFAULT HASH IS ADEQUATE FOR THE HASHSETS
	...
	{
		this.silentPut((E)obj);
		//JEXStatics.logManager.log("Change Aborted: " + obj.toString(), 0, this);
	}
	...
	public void changing(Observable obj, String accessorName)
	{
		...
		//JEXStatics.logManager.log("Changing: " + obj.toString(), 0, this);
	}
...
//			ret = ret + 
//		}
		//JEXStatics.logManager.log("size: "+this.size(), 0, this);
