...
public class TransferableTypeName implements Transferable {
	...
	public boolean isDataFlavorSupported(DataFlavor flavor) {
		if (flavor.equals(jexDataFlavor) || flavor.equals(DataFlavor.stringFlavor)) return true;
		return false;
	}
	...
	throws UnsupportedFlavorException
	{
		if (flavor.equals(jexDataFlavor)){
			JEXStatics.logManager.log("Transfering typename", 1, this);
			return tn;
		}
		else if (flavor.equals(DataFlavor.stringFlavor)){
			JEXStatics.logManager.log("Transfering string value "+tn.toString(), 1, this);
