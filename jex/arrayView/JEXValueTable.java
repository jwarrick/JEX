...
public class JEXValueTable extends JTable {
	...
	public void makeDataTable(JEXData data){
		...
		if (firstMap == null){
			...
			JEXStatics.logManager.log("Creating 0 dimension table view", 0, this);
			...
			JEXStatics.logManager.log("Creating 1 dimension table view", 0, this);
			Vector<String> column = new Vector<String>(0);
			...
			JEXStatics.logManager.log("Creating 2 dimension table view", 0, this);
