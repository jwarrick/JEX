...
//		return result;
		...
		if (thisLabelMap == null){
			JEXStatics.logManager.log("Didn't find a hash map for this label name "+name, 1, this);
		...
		if (color == null){
			JEXStatics.logManager.log("Didn't find a color for this label value "+value, 1, this);
...
//		return result;
		...
		if (thisLabelMap == null){
			JEXStatics.logManager.log("Didn't find a hash map for this label name "+label.getDataObjectName(), 1, this);
			thisLabelMap = new TreeMap<String,Color>();
		...
		if (color == null){
			JEXStatics.logManager.log("Didn't find a color for this label value "+label.toString(), 1, this);
			color = Color.getHSBColor( random.nextFloat(), 0.85F, 1.0F );
