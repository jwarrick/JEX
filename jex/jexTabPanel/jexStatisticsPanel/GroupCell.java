...
//		this.entryID = g.groupID;
		...
		if (entryID == null){
			JEXStatics.logManager.log("Initializing a cell with null entry ", 2, this);
		}
		else{
			JEXStatics.logManager.log("Initializing a cell with entry "+entryID, 2, this);
		}
		initialize();
	...
	/**
	 * Rebuild this arraycell
	 * Contacts the Selection manager to get the data typename to display
	 * and uses the JEXDataViewFactory to create a sub view
	 */
	public void rebuild(){
...
//		this.add(centerPane, BorderLayout.CENTER);
	...
	public void mouseReleased(MouseEvent e) {
		if (isSelected){
			JEXStatics.logManager.log("Unselecting "+entryID, 1, this);
			this.isSelected = false;
		}
		else{
			JEXStatics.logManager.log("Selecting entry "+entryID, 1, this);
