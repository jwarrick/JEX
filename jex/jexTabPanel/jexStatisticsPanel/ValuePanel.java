...
public class ValuePanel extends JPanel implements ActionListener, MouseListener{
	...
	public void valueViewedChange(){
		...
		if (tn == null) setIsViewed(false);
		else{
			if (tn.getType() == null || tn.getName() == null) setIsViewed(false);
			else if (tn.getType().equals(JEXData.VALUE) && tn.getName().equals(valueName)) setIsViewed(true);
