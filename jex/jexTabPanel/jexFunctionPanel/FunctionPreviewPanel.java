...
import plugins.workflow.PreviewMaker;
...
//		SSCenter.defaultCenter().connect(JEXStatics.emulatorPool, DatabaseEmulatorPool.SIG_ObjectsChanged_NULL, this, "refresh", (Class[])null);
...
//		JEXData data = JEXStatics.emulatorPool.getDataForPreview(previewTN, entry);
