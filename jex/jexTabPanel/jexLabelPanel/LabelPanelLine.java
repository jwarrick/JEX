...
public class LabelPanelLine extends JPanel implements ActionListener, MouseListener{
	...
	public LabelPanelLine(String labelName, TreeMap<String,Set<JEXEntry>> labels, LabelsPanel parent){
		...
		JEXStatics.logManager.log("Connected to database label selection signal", 0, this);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == reductionButton){
			JEXStatics.logManager.log("Reduction expansion button clicked, current status is "+expanded, 1, this);
	...
	public void mouseReleased(MouseEvent e) {
		JEXStatics.logManager.log("Label "+labelName+" clicked", 1, this);
