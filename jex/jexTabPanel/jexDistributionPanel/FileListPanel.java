...
public class FileListPanel extends DialogGlassCenterPanel implements ActionListener{
	...
	private void initialize(){
		...
		if (files2Distribute == null) files2Distribute = new Vector<File>();
	 ...
	 */
	public void yes(){
		JEXStatics.logManager.log("File list selected", 1, this);
	 ...
	 */
	public void cancel(){
		JEXStatics.logManager.log("Repository creation canceled", 1, this);
	...
	private File reNameFile(File f, int size){
		...
		if (index >= fileName.length()-1) return f;
		...
		JEXStatics.logManager.log("Moved file "+f.getPath()+" to new path "+dest.getPath(),1,this);
		return dest;
	}
...
//		File f = new File("/Volumes/shared/")
		...
		if (folderVisited != null){fc = new JFileChooser(folderVisited); }
...
//		JFileChooser fc = new JFileChooser();
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			JEXStatics.logManager.log("Treating file list...",1,this);
			...
			JEXStatics.logManager.log("File opening cancelled / not possible...",1,this);
		}
	}
	...
	private void setFiles2Distribute()
	{
		...
		if(foldersOrFilesView.isTicked()) // get selected files and files in selected folders
		{
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == loadButton){
			JEXStatics.logManager.log("Opening file loader...",1,this);
