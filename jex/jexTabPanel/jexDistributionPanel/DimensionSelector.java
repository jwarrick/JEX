...
//		sizeField.setPreferredSize(new Dimension(15, sizeField.getPreferredSize().height));
//		sizeField.setMaximumSize(new Dimension(15, sizeField.getPreferredSize().height));
		JEXStatics.logManager.log("Size of sizeField " + sizeField.getMaximumSize(), 0, this);
