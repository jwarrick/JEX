...
public class JEXNotesRightPanel extends JPanel implements ActionListener
{
	...
	JEXNotesRightPanel(JEXNotesPanelController parent)
	{
		...
		SSCenter.defaultCenter().connect(this.parent, JEXNotesPanelController.NAVIGATION_CHANGED, this, "changeDetected", (Class[])null);
	}
	...
	private void initializeGUI()
	{
		...
		databasePanel.add(new JLabel("Files attached to the database"),BorderLayout.PAGE_START);
		...
		experimentPanel.setBorder(BorderFactory.createLineBorder(Color.black, 2));
		experimentPanel.setLayout(new BorderLayout());
		experimentPanel.add(new JLabel("Files attached to the experiment"),BorderLayout.PAGE_START);
		...
		arrayPanel.add(new JLabel("Files attached to the array"),BorderLayout.PAGE_START);
	...
	public void drop(DropTargetDropEvent event) {
		...
		try {
			if (event.isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
				...
				JEXStatics.logManager.log("Droping files ",1,this);
