...
public class JEXNotesPanelController extends JEXTabPanelController{
	...
	public JEXNotesPanelController()
	{
		...
		SSCenter.defaultCenter().connect(JEXStatics.jexManager, JEXManager.DATASETS, this, "changeDetected", (Class[])null);
	...
	public void changeDetected()
	{
		...
		SSCenter.defaultCenter().emit(this, NAVIGATION_CHANGED, (Object[])null);
	}
