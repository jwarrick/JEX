...
public class ArrayPreview implements PaintComponentDelegate, MouseListener, MouseMotionListener{
	...
	{
		if((this.rows == 0 && this.cols == 0) || index.x < -1 || index.y < -1 || index.x > cols || index.y > rows) return;
