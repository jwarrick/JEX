...
public class KeyStatics {
    ...
    {
    	JEXStatics.logManager.log("AltDown:" + altIsDown() + ", MetaDown:" + metaIsDown() + ", ShiftDown:" + shiftIsDown() + ", CtrlDown:" + ctrlIsDown() + ", TabDown:" + tabIsDown() + ", EscapeDown:" + escapeIsDown() + ", CtrlOrCmdDown:" + ctrlOrCmdIsDown(), 0, KeyStatics.class);
    }
}
