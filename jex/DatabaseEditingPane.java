...
//	private   Repository rep;
	...
	private void initialize(){
    	...
    	// Fill the layout 
//    	JLabel repLabel = new JLabel("Repository");
//    	this.add(repLabel, cc.xy(1, 1));
//    	this.add(repField, cc.xywh(2, 1, 2, 1));
//    	repField.setText(rep.getPath());
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{
			JEXStatics.logManager.log("Database edition validated", 1, this);
//			String rep  = repField.getText();
			...
			JEXStatics.logManager.log("Database information changed: [Name = "+name+"] [Info = "+info+"] [Pass = "+password+"]", 1, this);
		}
	}
}
