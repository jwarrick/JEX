...
public class itnv extends TreeMap<JEXEntry,TreeMap<String,TreeMap<String,String>>>{
	...
	public boolean addEntry(JEXEntry entry, TreeMap<String,TreeMap<String,String>> tnv)
	{
		try
		{
			...
			JEXStatics.logManager.log("Adding to itnv failed", 1, this);
			return false;
		}
	...
	public boolean removeEntry(JEXEntry entry)
	{
		try
		{
			...
			JEXStatics.logManager.log("Removing from itnv failed", 1, this);
			return false;
		}
		return true;
	}
	...
	public boolean removeObjectFromEntry(JEXEntry entry, String objType, String objName)
	{
		...
		if (tnv == null)
		{
			JEXStatics.logManager.log("Entry doesn't exist in database", 1, this);
			return false;
		}
		...
		if (nv == null)
		{
			JEXStatics.logManager.log("Type doesn't exist in database", 1, this);
			return false;
		}
		...
		if (value == null)
		{
			JEXStatics.logManager.log("Object TypeName doesn't exist in database", 1, this);
			return false;
		}
		...
		if (nv.size() == 0) tnv.remove(objType);
	...
	public boolean addObjectToEntry(JEXEntry entry, String objType, String objName, String objValue)
	{
		...
		if (value != null)
		{
			JEXStatics.logManager.log("Object typename already exists in the database", 1, this);
			return false;
		}
