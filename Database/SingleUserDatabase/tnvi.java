...
public class tnvi extends TreeMap<String,TreeMap<String,TreeMap<String,Set<JEXEntry>>>> {
	...
	/**
	 * Add an entry to this TNVI dictionary.
	 * For each data contained in this entry, add the entry to the entry
	 * list keyed by each JEXData in the entry
	 * Send a change signal after completion.
	 * @param entry
	 * @param tnv
	 * @return
	 */
...
//		}
	 ...
	 * For each data contained in this entry, add the entry to the entry
	 * list keyed by each JEXData in the entry
	 * Perform the task WITHOUT sending a change signal after completion.
	 * @param entry
	 * @return
	 */
	public boolean _addEntryForAllDataInEntry(JEXEntry entry)
	{
		...
		for (String type: entry.getDataList().keySet())
		{
			// Get the nvi
...
//				String value = addNV.get(name).getDictionaryValue();
	...
	/**
	 * Remove the entry from the TNVI dictionary.
	 * Remove the entry from the entry list keyed by each
	 * data in the entry.
	 * @param entry
	 * @return
	 */
...
//		}
	...
	/**
	 * Add to the entry ENTRY the object 
	 * of type OBJTYPE, name OBJNAME, and value OBJVALUE
	 * @param entry
	 * @param objType
	 * @param objName
	 * @param objValue
...
//	/**
//	 * Add a TNV to the TNVI
//	 * @param entry
//	 * @param tnv
//	 */
//	public void OLDupdateEntry(JEXEntry entry, TreeMap<String,TreeMap<String,String>> tnv)
//	{
//		// Add to the tnvi
//		for (String type: tnv.keySet())
//		{
//			TreeMap<String,TreeMap<String,Set<JEXEntry>>> existingTNV = this.get(type);
//			TreeMap<String,String> nv = tnv.get(type);
//			
//			// if the type doesn't exist add all
//			if (existingTNV == null)
//			{
//				existingTNV = new TreeMap<String,TreeMap<String,Set<JEXEntry>>>();
//				this.put(type, existingTNV);
//			}
//			
//			// Get the name
//			for (String name: nv.keySet())
//			{
//				TreeMap<String,Set<JEXEntry>> existingNV = existingTNV.get(name);
//				String value = nv.get(name);
//				
//				// If the name doesn't exist add it
//				if (existingNV == null)
//				{
//					existingNV = new TreeMap<String,Set<JEXEntry>>();
//					existingTNV.put(name, existingNV);
//				}
//				
//				// Get the value
//				Set<JEXEntry> existingEntries = existingNV.get(value);
//				
//				// If it doesn't exist create a new one
//				if (existingEntries == null)
//				{
//					existingEntries = new TreeSet<JEXEntry>();
//					existingNV.put(value, existingEntries);
//				}
//				
//				// Add the entry
...
//	}
	...
	{
		JEXStatics.logManager.log("TNVI has changed sending signal", 2, this);
	...
	public int hashCode()
	{
		if (hashString == null) return super.hashCode();
