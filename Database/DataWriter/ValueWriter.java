...
public class ValueWriter {
	...
	/**
	 * Make an value object containing an value list, each value is at an index defined by an
	 * index from the list INDEXES, a value from VALUES and a dimension name
	 * @param objectName
	 * @param values
	 * @param indexes
	 * @param dimensionName
	 * @return data
	 */
	public static JEXData makeValueStack(String objectName, String[] values, 
										 String[] indexes, String dimensionName){
		JEXData data = new JEXData(JEXData.VALUE,objectName);
...
//	 * @return
//	 */
//	public static JEXData makeValueTable(String objectName, TreeMap<DimensionMap, String> valueMap){
