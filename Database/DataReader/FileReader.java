...
public class FileReader {
	...
	{
		String relativePath = ds.get(JEXDataSingle.RELATIVEPATH);
	...
	{
		if (!data.getDataObjectType().equals(JEXData.FILE)) return null;
	...
	public static TreeMap<DimensionMap,String> readObjectToFilePathTable(JEXData data)
	{
		...
		JEXDataSingle ds = data.getFirstSingle();
		String dataFolder = FileReader.readToFile(ds).getParent(); // DO THIS ONE TIME OUTSIDE LOOP OTHERWISE YOU WILL CHECK IF THIS DIRECTORY EXISTS FOR EACH DATASINGLE IN THE JEXDATA! (MAJORLY SLOW)
