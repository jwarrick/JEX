...
public class Dim implements Copiable<Dim>
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4341824757161314628L;
	...
	public Dim(String dimName, List<String> values)
	{
	...
	public Dim(String dimName, String value)
	{
		this.dimName = dimName;
		this.dimValues = new Vector<String>();
		this.dimValues.add(value);
		this.updateDimValueSet();
	}
	...
	{
		if(!dim1.name().equals(dim2.name())) return null;
	...
	public String toCSVString(){
		if (dimName==null || dimValues==null) return "";
		
		String result = dimName;
